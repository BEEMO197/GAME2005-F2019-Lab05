...
{
	if	(object1->getPosition().x + object1->getWidth() >= object2->getPosition().x &&
			object1->getPosition().x <= object2->getPosition().x + object2->getWidth() &&
			object1->getPosition().y + object1->getWidth() >= object2->getPosition().y &&
			object1->getPosition().y <= object2->getPosition().y + object2->getWidth())
	{
		if (!object2->getIsColliding())
		{
			object2->setIsColliding(true);
